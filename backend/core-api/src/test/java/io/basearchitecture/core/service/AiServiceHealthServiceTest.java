...
class AiServiceHealthServiceTest {
    ...
    void mapsValidatedPayloadToApplicationResult() {
        ...
        assertEquals("base-architecture-ai-service", result.service());
    }
    ...
    private static Stream<AiServiceHealthPayload> invalidPayloads() {
        return Stream.of(
                new AiServiceHealthPayload(null, "base-architecture-ai-service"),
                new AiServiceHealthPayload("up", null),
                new AiServiceHealthPayload("down", "base-architecture-ai-service"),
