...
class AiServiceHealthControllerTest {
    ...
    void returnsPublicHealthContract() throws Exception {
        when(client.getHealth()).thenReturn(
                new AiServiceHealthPayload("up", "base-architecture-ai-service"));

        mockMvc.perform(get(PATH))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.status").value("up"))
                .andExpect(jsonPath("$.service").value("base-architecture-ai-service"));
    }
    ...
    private static Stream<Arguments> problemCases() {
        return Stream.of(
                Arguments.of(
                        ...
                        "urn:base-architecture:problem:ai-service-upstream-error",
                ...
                Arguments.of(
                        ...
                        "urn:base-architecture:problem:ai-service-invalid-response",
                ...
                Arguments.of(
                        ...
                        "urn:base-architecture:problem:ai-service-unavailable",
                ...
                Arguments.of(
                        ...
                        504,
                        "AI_SERVICE_TIMEOUT",
                        "urn:base-architecture:problem:ai-service-timeout",
