...
import io.basearchitecture.core.service.AiServiceHealthException;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleMethodArgumentNotValidException(
        ...
        return validationProblem(
                ...
                URI.create("urn:base-architecture:problem:request-validation-failed"),
    ...
    public ResponseEntity<ProblemDetail> handleHttpMediaTypeNotSupportedException(
        ...
        return validationProblem(
                ...
                URI.create("urn:base-architecture:problem:unsupported-media-type"),
    ...
    private static ProblemDefinition definitionFor(AiServiceHealthException.Failure failure) {
        return switch (failure) {
            case UPSTREAM_ERROR -> new ProblemDefinition(
                    ...
                    URI.create("urn:base-architecture:problem:ai-service-upstream-error"),
            ...
            case INVALID_RESPONSE -> new ProblemDefinition(
                    HttpStatus.BAD_GATEWAY,
                    URI.create("urn:base-architecture:problem:ai-service-invalid-response"),
                    "AI Service Invalid Response",
                    "AI Service returned an invalid response.",
                    "AI_SERVICE_INVALID_RESPONSE");
            case UNAVAILABLE -> new ProblemDefinition(
                    HttpStatus.SERVICE_UNAVAILABLE,
                    URI.create("urn:base-architecture:problem:ai-service-unavailable"),
                    "AI Service Unavailable",
                    "AI Service is currently unavailable.",
                    "AI_SERVICE_UNAVAILABLE");
            case TIMEOUT -> new ProblemDefinition(
                    HttpStatus.GATEWAY_TIMEOUT,
                    URI.create("urn:base-architecture:problem:ai-service-timeout"),
